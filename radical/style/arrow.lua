...
local function _set_direction(data,direction)
  ...
  local border_color = color(beautiful.border_normal or beautiful.menu_border_color or beautiful.fg_normal)
...
local function draw_border(self,w, cr, width, height)
  ...
  cr:set_source(color(beautiful.border_normal or beautiful.menu_border_color or beautiful.fg_normal))
