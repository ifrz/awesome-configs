...
local currentMenu = radical.box({filter = true,item_height=24,style = radical.style.classic, border_width = 2,
show_filter=not auto_release, autodiscard = true,
