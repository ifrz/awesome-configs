...
theme.taglist = blind {
    ...
    default_icon       = path .."Icon/tags/net.png",
    index_per_state = false, --true
...
theme.menu = blind {
    ...
    bg_normal    = blind_pat.to_pattern(blind_pat.mask.noise(0,"#AAAACC", blind_pat.sur.plain("#2F363B",default_height))),
